...
void FirstPersonCamera::setmPosition(float xPos, float yPos, float zPos)
{
	mPosition = vec3(xPos, yPos, zPos);	
}


void FirstPersonCamera::setmDirection(float xPos, float yPos, float zPos)
{	
	mDirection = normalize(mPosition - vec3(xPos, yPos, zPos));	
}
